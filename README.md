# LumynaX Reranker BGE v2 M3

> 🇳🇿 **Made in Aotearoa New Zealand** by **AbteeX AI Labs** — part of the **LumynaX** sovereign-AI release family.

[🤗 Weights & model card on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-reranker-bge-v2-m3) · [abteex.com](https://abteex.com) · [lumynax.com](https://lumynax.com) · [Monorepo](https://github.com/Aimaghsoodi/lumynax-release)

---

This GitHub repo mirrors the **runtime scaffolding** (quickstart, requirements, Modelfile, Space, docs). The model **weights** are published on Hugging Face at `AbteeXAILab/lumynax-reranker-bge-v2-m3` — they exceed GitHub's per-file limit.

```bash
hf download AbteeXAILab/lumynax-reranker-bge-v2-m3 --local-dir lumynax-reranker-bge-v2-m3
cd lumynax-reranker-bge-v2-m3 && pip install -r requirements.txt && python quickstart.py --interactive
# Or:  pip install lumynax && lumynax run lumynax-reranker-bge-v2-m3 -i
```
...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Reranker BGE v2 M3 release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Reranker BGE v2 M3</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: bge" src="https://img.shields.io/badge/Family-bge-9a5416?style=for-the-badge" />  <img alt="Runtime: transformers" src="https://img.shields.io/badge/Runtime-transformers-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: 0.568B" src="https://img.shields.io/badge/Params-0.568B-0a0a0b?style=for-the-badge" />  <img alt="Quant: fp32 safetensors" src="https://img.shields.io/badge/Quant-fp32%20safetensors-111827?style=for-the-badge" />  <img alt="Context: 8192%20tok" src="https://img.shields.io/badge/Context-8192%20tok-111827?style=for-the-badge" />  <img alt="License: mit" src="https://img.shields.io/badge/License-mit-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%203" src="https://img.shields.io/badge/Sovereignty-tier%203-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>5/5</b></kbd> &middot; <kbd>Lightweight: <b>5/5</b></kbd> &middot; <kbd>Sovereignty: <b>3/5</b></kbd> &middot; <kbd>Tools: <b>no</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>8192 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-reranker-bge-v2-m3` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
tokenizer = AutoTokenizer.from_pretrained("AbteeXAILab/lumynax-reranker-bge-v2-m3", trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained("AbteeXAILab/lumynax-reranker-bge-v2-m3", device_map="auto", trust_remote_code=True)
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Reranker BGE v2 M3` |
| Repository | `AbteeXAILab/lumynax-reranker-bge-v2-m3` |
| Family | `bge` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `BAAI/bge-reranker-v2-m3` |
| Source | `BAAI BGE reranker` |
| License | `mit` |
...
```text
You are LumynaX operating from the LumynaX Reranker BGE v2 M3 package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
